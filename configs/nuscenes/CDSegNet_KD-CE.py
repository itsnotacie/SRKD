...
# ---- common ---
batch_size = 12 # bs=2 for 1 GPU, bs=4 for 2 GPUs, bs=8 for 4GPUs
num_worker = 12 # the num_worker is double batch_size.
mix_prob = 0.8
...
T = 1000
T_dim = 128
beta_start = 0.002 # 0 # 0.001 0.0001
beta_end = 0.003 # 1000 # 0.005 0.002
...
# model settings
model = dict(
    type="KD_DefaultSegmentorV2",
    t_weight="/root/weights/model_best.pth",
    # t_weight="",
    t_backbone=dict(
        type="PT-v3m1",
    ...
    criteria=[
        ...
        dict(type="KDLoss_CE", temperature=2.0, loss_weight=0.1, ignore_index=ignore_index),
    ],
