...
def main():
    ...
    config = "CDSegNet_KD-CE" # {CDSegNet_KD-CE, CDSegNet_CIRKD, PTv3_HalfChannel}
    ...
    noise_level = None
    # options = {'save_path': f'./exp/{dataset}_test/{config}/noise_{noise_level}'}
    options = {'save_path': f'./exp/{dataset}_test/{config}/test'}
